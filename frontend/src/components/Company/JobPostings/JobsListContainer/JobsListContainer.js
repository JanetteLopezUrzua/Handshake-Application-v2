      ...
      <Row>
        <Col sm={5}>
          ...
          >
            ...
            Deadline: {months[props.job.deadlinemonth - 1]}{" "}
            {props.job.deadlineday}, {props.job.deadlineyear}
          </Card.Title>
        ...
        <Col sm={5} style={{ marginTop: "22px" }}>
          <Card.Title className="studentslistinfo">
            {" "}
            Salary: {props.job.salary} per {props.job.salarytime}
          </Card.Title>
          <Card.Title className="studentslistinfo">
            {" "}
