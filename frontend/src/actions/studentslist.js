...
// export const searchstudentslist = (nameorcollege, major) => async (
//   dispatch
// ) => {
//   if (localStorage.token) {
//     setAuthToken(localStorage.token);
...
//   try {
//     const res = await axios.get(
//       `http://localhost:3001/students/studentslistsearch?page=${page}&nameorcollege=${nameorcollege}&major=${major}`
//     );
